...
def run_process_collet_code_list():
...
if __name__ == "__main__":
    ...
    schduler.add_job(func=run_process_collet_code_list, trigger="cron", 
                        day_of_week="mon-fri", hour="21", minute="10", id="1")
    schduler.add_job(func=run_process_collect_stock_info, trigger="cron", 
